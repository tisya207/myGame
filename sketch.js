...
movedPuzzle1 = true
  ...
  else if(!movedPuzzle5 && mouseX>=150 && mouseX<=200 && mouseY>=325 && mouseY<=375){
                console.log("puzzle5")
                shiftPuzzle5 = true
                movedPuzzle5 = true
                          }
  else if(!movedPuzzle6 && mouseX>=300 && mouseX<=350 && mouseY>=325 && mouseY<=375){
                            console.log("puzzle6")
                            shiftPuzzle6 = true
                            movedPuzzle6 = true
                                      }      

else if(!movedPuzzle7 && mouseX>=475 && mouseX<=525 && mouseY>=325 && mouseY<=375){
  console.log("puzzle7")
  shiftPuzzle7 = true
  movedPuzzle7 = true
            } 
